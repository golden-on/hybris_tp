...
public class RequiredAttributeTestFactory
{
	...
	public static RequiredAttribute prepareStructureForCatalogVersion(final boolean mandatory, final boolean unique)
	{
		final RequiredAttribute catalogVersionOfProduct = new RequiredAttribute(prepareComposedType(CatalogVersionModel._TYPECODE),
				ProductModel._TYPECODE, ProductModel.CATALOGVERSION, unique, mandatory, false);
	...
	public static RequiredAttribute prepareStructureForSupercategories(final boolean unique, final boolean mandatory)
	{
