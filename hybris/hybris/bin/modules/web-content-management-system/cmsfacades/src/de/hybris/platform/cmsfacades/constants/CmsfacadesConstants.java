...
public final class CmsfacadesConstants extends GeneratedCmsfacadesConstants
{
	...
	public static final String UNAPPROVED_SYNCHRONIZATION_REQUEST = "unapproved.synchronization.request";
	...
	public static final String CONTENT_SLOT_INVALID_UID = "content.slot.invalid.uid";
	...
	public static final String PAGE_IN_WORKFLOW_CANNOT_BE_TRASHED = "page.in.workflow.cannot.be.trashed";
	...
	public static final String WORKFLOW_MISSING_ATTACHMENTS = "cmsworkflow.missing.attachments";
	public static final String WORKFLOW_INVALID_ATTACHMENTS = "cmsworkflow.attachments.invalid";
	public static final String WORKFLOW_INVALID_ATTACHMENT = "cmsworkflow.attachment.invalid";
	public static final String WORKFLOW_ATTACHMENTS_ALREADY_IN_WORKFLOW = "cmsworkflow.attachments.already.in.workflow";
	public static final String WORKFLOW_INVALID_ID = "cmsworkflow.invalid.workflow.id";
	public static final String WORKFLOW_INVALID_STATUS = "cmsworkflow.status.invalid";
	public static final String WORKFLOW_CANNOT_UPDATE_ATTACHMENTS = "cmsworkflow.cannot.update.attachments";
	public static final String WORKFLOW_CANNOT_UPDATE_STATUS = "cmsworkflow.cannot.update.status";
	public static final String WORKFLOW_CODE_MISMATCH = "cmsworkflow.code.mismatch";
	public static final String WORKFLOW_CONTEXT_ITEM_UUID = "workflowContextItemUuid";
	public static final String ITEM_IN_WORKFLOW_NOT_EDITABLE_BY_CURRENT_USER = "item.in.workflow.not.editable.by.current.user";
	public static final String TYPE_READONLY_MODE = "typeReadOnlyMode";
	public static final String TYPE_REQUIRED_FIELDS = "typeRequiredFields";
	...
	public static final String FIELD_VERSION_LABEL = "versionLabel";
	public static final String FIELD_WORKFLOW_ID = "workflowId";
	public static final String FIELD_WORKFLOW_CODE = "workflowCode";
	public static final String FIELD_WORKFLOW_STATUS = "status";
