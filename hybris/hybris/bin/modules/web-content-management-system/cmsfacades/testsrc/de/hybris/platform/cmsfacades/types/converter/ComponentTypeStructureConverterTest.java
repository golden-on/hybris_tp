...
public class ComponentTypeStructureConverterTest
{
	...
	{
		verify(popAttribute1, never()).populate(Mockito.eq(attribute1), Mockito.any(ComponentTypeAttributeData.class));
		verify(popAttribute2, never()).populate(Mockito.eq(attribute1), Mockito.any(ComponentTypeAttributeData.class));
		verify(popAttribute1, never()).populate(Mockito.eq(attribute2), Mockito.any(ComponentTypeAttributeData.class));
		verify(popAttribute2, never()).populate(Mockito.eq(attribute2), Mockito.any(ComponentTypeAttributeData.class));
	}
