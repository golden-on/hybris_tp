...
public class ConfigurationFacadeImplTest
{
	...
	{
		initializeFirstCall();
		ConfigurationData configContent = classUnderTest.getConfiguration(kbKey);
	...
	public void testUpdateConfiguration() throws Exception
	{
		...
		final ConfigurationData configContentBeforeUpdate = classUnderTest.getConfiguration(kbKey);
	...
	{
		final ConfigModel createdConfigModel = initializeFirstCall();
		final ConfigurationData configData = classUnderTest.getConfiguration(kbKey);
	...
	{
		initializeFirstCall();
		final ConfigurationData configuration = classUnderTest.createConfiguration(kbKey);
	...
	public void testIsConfigurationAvailableTrue()
	{
		initializeFirstCall();
		final Throwable ex = new IllegalStateException(new ConfigurationNotFoundException());
		given(configServiceMock.retrieveConfigurationModel(CONFIG_ID)).willReturn(configModelConflicts);
	...
	{
		initializeFirstCall();
		given(configServiceMock.retrieveConfigurationModel(CONFIG_ID)).willReturn(null);
		assertFalse(classUnderTest.isConfigurationAvailable(CONFIG_ID));
	}
}
