...
angular
    ...
    .service('cmsGenericEditorConfigurationService', function(editorFieldMappingService, genericEditorTabService, sanitize) {
        ...
        this.setDefaultEditorFieldMappings = function() {
            ...
            editorFieldMappingService.addFieldMapping('InfoPageName', this._isPagePredicate, null, {
                template: 'infoPageNameWrapperTemplate.html'
            });

            editorFieldMappingService.addFieldMapping('PageInfoPageName', this._isPagePredicate, null, {
            ...
            editorFieldMappingService.addFieldMapping('WorkflowCreateVersionField', null, null, {
