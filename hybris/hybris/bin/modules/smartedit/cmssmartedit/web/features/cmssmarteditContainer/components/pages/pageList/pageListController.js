...
angular.module('pageListControllerModule', [
    ...
    .controller('pageListController', function(
        $routeParams, $translate, $scope, $q, EVENT_CONTENT_CATALOG_UPDATE, lodash, cmsitemsUri,
        urlService, catalogService, addPageWizardService, systemEventService, experienceService, catalogVersionPermissionService) {
