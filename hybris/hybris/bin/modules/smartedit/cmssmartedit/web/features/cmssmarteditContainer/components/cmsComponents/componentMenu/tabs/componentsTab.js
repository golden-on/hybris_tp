 ...
 */
angular.module('componentsTabModule', ['componentMenuServiceModule', 'componentItemModule'])

    .constant('ENABLE_CLONE_ON_DROP', 'enableCloneComponentOnDrop')

    .controller('componentsTabController', function($q, lodash, componentMenuService, componentService, sharedDataService, ENABLE_CLONE_ON_DROP) {
