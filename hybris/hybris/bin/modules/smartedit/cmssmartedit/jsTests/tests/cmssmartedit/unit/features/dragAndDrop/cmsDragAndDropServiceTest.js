...
describe('cmsDragAndDropService', function() {
    ...
    beforeEach(function() {
        var harness = AngularUnitTestHelper
            ...
            .mock('slotRestrictionsService', 'isComponentAllowedInSlot')
            .mock('slotRestrictionsService', 'isSlotEditable')
            ...
            .mockConstant('COMPONENT_IN_SLOT_STATUS', {
                ALLOWED: 'allowed',
        ...
        harness.mocks.pageContentSlotsComponentsRestService.getComponentsForSlot.and.returnValue([]);
    });
