...
describe('componentCloneInfoForm', function() {
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('componentCloneInfoFormModule')
            ...
            .mock('pageService', 'primaryPageForPageTypeExists').and.returnValue(resource)
    ...
    it('GIVEN a category page WHEN onInit is called and there exists a primary category page in the selected catalog version THEN it should set "catalogVersionContainsPageWithSameTypeCode" to true', function() {
        mocks.pageService.primaryPageForPageTypeExists.and.returnValue($q.when(true));
    ...
    it('GIVEN a content page WHEN onInit is called THEN "catalogVersionContainsPageWithSameTypeCode" should be false', function() {
        //GIVEN
