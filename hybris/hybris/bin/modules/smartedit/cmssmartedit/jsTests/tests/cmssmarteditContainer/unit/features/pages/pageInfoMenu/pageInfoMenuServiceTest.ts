...
import {CmsApprovalStatus, CMSItemStructure, CMSItemStructureField, CMSPageStatus, CMSPageTypes, ICMSPage} from 'cmscommons';
...
describe('PageInfoMenuService', () => {
	...
	beforeEach(() => {
		...
		pageInfoMenuService = new PageInfoMenuService(pageService, pageEditorModalService, cmsitemsRestService,
			typeStructureRestService, displayConditionsFacade, pageVersionSelectionService, lo, $translate, $q, $log);
	});
