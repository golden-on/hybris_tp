...
module.exports = (function() {
    ...
    componentMenu.elements = {
        ...
        getComponentTypesSearchBox: function() {
            return this.getComponentsTypesTab().element(by.css('.se-component-menu__input-group .se-input-group__input-area'));
        },
        ...
        getComponentsTabScrollElement: function() {
            return browser.findElement(
                by.css('[data-tab-id="componentsTab"] .se-component-menu__infinite-scroll > div')
            );
        },
        getExistingComponentById: function(componentId) {
            return this.getComponentsTab().element(by.css('.se-component-item.smartEditComponent[data-smartedit-component-id="' + componentId + '"] '));
        },
        getExistingComponentSharedIndicatorById: function(componentId) {
            return this.getExistingComponentById(componentId).element(by.css('.se-component-item--image-shared'));
        },
            ...
            return browser.waitUntil(function() {
                return componentMenu.elements.getComponents().then(function(components) {
                    if (components.length > currentNumOfComponents) {
                        ...
                        browser.scrollToBottom(componentMenu.elements.getComponentsTabScrollElement());
                    }
    ...
    componentMenu.assertions = {
        ...
        assertExistingComponentIsShared: function(componentId) {
            expect(componentMenu.elements.getExistingComponentSharedIndicatorById(componentId).isDisplayed()).toBe(true);
        },
        assertExistingComponentIsNotShared: function(componentId) {
            expect(browser.isAbsent(componentMenu.elements.getExistingComponentSharedIndicatorById(componentId))).toBe(true);
        }
    };
