...
public class CategorySearchController
{
	...
	public CategorySearchResultWsDTO findProductCategoriesByTextOrMask(final String text, final String mask, final PageableWsDTO pageableDto)
	{
		return findProductCategoriesByTextOrMask(text, mask, pageableDto, null);
	}

	@RequestMapping(method = RequestMethod.GET, params = { "pageSize" })
	@ResponseBody
	@ApiOperation(value = "Find product categories by text or mask and language iso code", notes = "Endpoint to find product categories using a free text search field.")
	@ApiResponses({
	...
	public CategorySearchResultWsDTO findProductCategoriesByTextOrMask(
			...
			@ApiParam(value = "The language iso code used to filter products") @RequestParam(required = false) final String langIsoCode)
	{
