...
public interface ProductSearchFacade
{
	...
	default SearchResult<ProductData> findProducts(final String text, final PageableData pageableData, final String langIsoCode)
	{
		return findProducts(text, pageableData);
	}
	...
	default SearchResult<CategoryData> findProductCategories(final String text, final PageableData pageableData, final String langIsoCode)
	{
		return findProductCategories(text, pageableData);
	}
