                    ...
                    files: [
                        // includes files within path
                        {
                            ...
                            src: [
                                ...
                                '!web/app/common/**/*'+global.smartedit.bundlePaths.test.testFileSuffix+'.+(js|ts)',
                                'web/app/smarteditloader/**/*.js', 'web/app/smarteditloader/**/*.ts',
                                paths.web.smarteditcontainer.allJs, 'web/app/smarteditcontainer/**/*.ts',
                                paths.web.smartEdit.allJs, 'web/app/smartedit/**/*.ts', 'web/app/vendor/**/*.ts',
                    ...
                    files: [
                        {
                            expand: true,
                            flatten: true,
                            src: ['smartedit-build/lib/smarteditcommons/dist/smarteditcommons.js*(.map)', 'smartedit-build/lib/vendors/*'],
                            dest: paths.web.webroot.staticResources.dir + '/dist/smarteditcommons/js'
                        }
                    ]
                },
                fonts: {
