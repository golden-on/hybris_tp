...
import {ISEDropdownService, SEDropdownAPI, SEDropdownConfiguration} from "./types";
...
export const SEDropdownServiceFactory = (
	...
	return class implements ISEDropdownService {
		...
		public getState(field: GenericEditorField) {
		...
		public isPopulatorPaged(populatorName: string) {
