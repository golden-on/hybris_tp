 ...
 */
import {IProduct, IRestService, IRestServiceFactory, LanguageService, Page, Pageable, SeInjectable} from 'smarteditcommons';
...
export class ProductService {
	...
	constructor(private restServiceFactory: IRestServiceFactory, private languageService: LanguageService, PRODUCT_RESOURCE_API: string, PRODUCT_LIST_RESOURCE_API: string) {
