...
export class StringUtils {
	 ...
	 * The method is deprecated since 1808. Since some extension / customer may want to use it, we can't delete it directly, otherwise it might break build process.
	 */
	sanitize = (str: string): string => {
		// ECP-4765 don't sanitize the string
		return str;
