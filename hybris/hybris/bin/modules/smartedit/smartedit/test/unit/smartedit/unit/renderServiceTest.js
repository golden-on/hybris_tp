...
describe('renderService', function() {
    ...
    var crossFrameEventService, systemEventService, alertService, yjQuery, componentHandlerService, extractFromElement,
        gatewayFactory, gatewayProxy, unsafeParseHTML, renderService, sakExecutor,
        smarteditBootstrapGateway, perspectiveService, CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS,
    ...
    beforeEach(angular.mock.module('yjqueryModule', function($provide) {
    ...
    describe('renderRemoval', function() {
        ...
        beforeEach(function() {
            renderService.renderRemoval(COMPONENT_ID, COMPONENT_TYPE, SLOT_ID_1);
        });
    ...
    describe('renderSlots', function() {
        ...
        describe('when multiple slot IDs are provided and http request succeeds', function() {
            ...
            beforeEach(function() {
                ...
                yjQuery.and.callFake(function(selector) {
                    if (selector === EXPECTED_SLOT_1_SELECTOR) {
            ...
            it('should get the existing slots elements to replace from the current storefront', function() {
                expect(yjQuery.calls.count()).toBe(2);
                expect(yjQuery.calls.argsFor(0)[0]).toBe(EXPECTED_SLOT_1_SELECTOR);
                expect(yjQuery.calls.argsFor(1)[0]).toBe(EXPECTED_SLOT_2_SELECTOR);
            });
    ...
    describe('refreshOverlayDimensions', function() {
        ...
        beforeEach(function() {
            yjQuery.and.callFake(function(element) {
                if (element === 'body') {
                    return element;
        ...
        it('should fetch the body as the element when given no parameters', function() {
            ...
            expect(yjQuery).toHaveBeenCalledWith(BODY_TAG);
        });
        ...
        it('should use the element provided instead of the body when provided with an element', function() {
            ...
            expect(yjQuery).not.toHaveBeenCalled();
        });
    ...
    describe('_updateComponentSizeAndPosition', function() {
        ...
        beforeEach(function() {
            ...
            yjQuery.and.callFake(function(object) {
    ...
    describe('_cloneComponent', function() {
        ...
        var element, parentOverlay, document, shallowCopy, smartEditWrapper, componentDecorator;
        var attrMap = {};
        ...
        beforeEach(function() {
            ...
            renderService._cloneComponent(element);
        });
        ...
        it('should fetch a wrapped SmartEdit decorator wrapper', function() {
            expect(yjQuery).toHaveBeenCalledWith(smartEditWrapper);
        });
        ...
        describe('when component is a NavigationBarCollectionComponent', function() {
            beforeEach(function() {
                ...
                renderService._cloneComponent(element, parentOverlay);
            });
    ...
    describe('_createComponent', function() {
        ...
        beforeEach(function() {
            ...
            spyOn(renderService, '_getParentInOverlay').and.returnValue(parentOverlay);
            spyOn(renderService, '_cloneComponent');
        ...
        it('should clone and compile the targeted element only', function() {
            ...
            expect(renderService._cloneComponent).toHaveBeenCalledWith(element);
        ...
        it('should not clone if element is not visible', function() {
            ...
            // Assert
            expect(renderService._isComponentVisible.calls.count()).toBe(1);
            expect(renderService._cloneComponent).not.toHaveBeenCalled();
            expect(renderService._createComponent.calls.count()).toBe(1);
        });
    });
    ...
    describe('_destroyComponent', function() {
        ...
        it('will destroy overlay component with id and type from component', function() {
        ...
        it('will destroy overlay component with id and type from slot', function() {
        ...
        it('will destroy overlay component with id and type from component from old attributes', function() {
            parent.attr.and.returnValue(slotId);
