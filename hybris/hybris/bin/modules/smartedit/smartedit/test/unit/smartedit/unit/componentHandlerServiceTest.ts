...
describe('componentHandlerService - inner', () => {
	...
	beforeEach(() => {
		...
		componentHandlerService = new ComponentHandlerService(
			yjQuery,
			isBlank,
			lo,
			"smarteditoverlay",
			...
			'smartEditComponent',
			'smartEditComponentX',
			'data-smartedit-container-id',
			'data-smartedit-container-type',
	...
	it('getComponent will get a yjQuery reference on an object containing the given class and having the given id and type', () => {
		...
		expect(yjQuery).toHaveBeenCalledWith(".myclass[data-smartedit-component-id='theid'][data-smartedit-component-type='thetype']");
	});
	...
	it('getComponentUnderSlot will get a yjQuery reference on an object containing the given class and having the given id and type', () => {
		...
		expect(yjQuery).toHaveBeenCalledWith("[data-smartedit-component-id='theSlotId'][data-smartedit-component-type='ContentSlot'] .myclass[data-smartedit-component-id='theComponentId'][data-smartedit-component-type='thetype']");
	});
	...
	it('getOriginalComponent will get a yjQuery reference on an object containing the smartEditComponent class and having the given id and type', () => {
		...
		expect(yjQuery).toHaveBeenCalledWith(".smartEditComponent[data-smartedit-component-id='theid'][data-smartedit-component-type='thetype']");
	});
	...
	it('getOriginalComponentWithinSlot will get a yjQuery reference on an object containing the smartEditComponent class and having the given id and type within a given slot ID', () => {
		...
		expect(yjQuery).toHaveBeenCalledWith("[data-smartedit-component-id='theSlotId'][data-smartedit-component-type='ContentSlot'] .smartEditComponent[data-smartedit-component-id='theid'][data-smartedit-component-type='thetype']");
	});
	...
	it('getOverlayComponentWithinSlot will get a yjQuery reference on an object containing the smartEditComponent class and having the given id and type within a given slot ID', () => {
		...
		expect(yjQuery).toHaveBeenCalledWith("[data-smartedit-component-id='theSlotId'][data-smartedit-component-type='ContentSlot'] .smartEditComponentX[data-smartedit-component-id='theid'][data-smartedit-component-type='thetype']");
	});
	...
	it('getOverlayComponent will fetch component under slot in the overlay', () => {
		...
		expect(yjQuery).toHaveBeenCalledWith("[data-smartedit-component-id='slotId'][data-smartedit-component-type='ContentSlot'] .smartEditComponentX[data-smartedit-component-id='theid'][data-smartedit-component-type='thetype']");
	});
	...
	it('getOverlayComponent will fetch slot under in the overlay', () => {
		...
		expect(componentHandlerService.getParentSlotForComponent).toHaveBeenCalledWith(parent);
		expect(yjQuery).toHaveBeenCalledWith(".smartEditComponentX[data-smartedit-component-id='theid'][data-smartedit-component-type='thetype']");
	});
	...
	it('getComponentPositionInSlot will return the position for the given component within a slot', () => {
		...
		(componentHandlerService as jasmine.SpyObj<ComponentHandlerService>).getId.and.callFake(function(component: HTMLElement) {
			return component.id;
		});
