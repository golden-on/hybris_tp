...
public class GeneratedCommerceServicesConstants
{
	...
	{
		public static final String CONSENT = "Consent".intern();
		public static final String CONSENTTEMPLATE = "ConsentTemplate".intern();
		public static final String COUNTRYTYPE = "CountryType".intern();
		...
		public static final String QUOTENOTIFICATIONTYPE = "QuoteNotificationType".intern();
	...
	public static class Attributes
	{
		...
		{
			public static final String BILLINGCOUNTRIES = "billingCountries".intern();
		...
		public static class Country
		{
			...
			public static final String BILLINGBASESTORES = "billingBaseStores".intern();
		}
		...
		public static class Product
		{
			...
			public static final String REVIEWCOUNT = "reviewCount".intern();
			public static final String REVIEWRATING = "reviewRating".intern();
		...
		public static class Quote
		{
			...
			public static final String GENERATEDNOTIFICATIONS = "generatedNotifications".intern();
			public static final String PREVIOUSESTIMATEDTOTAL = "previousEstimatedTotal".intern();
		}
	...
	public static class Enumerations
	{
		public static class ConsignmentStatus
		{
			...
			public static final String TAX_NOT_COMMITTED = "TAX_NOT_COMMITTED".intern();
		}
		public static class CountryType
		{
			public static final String SHIPPING = "SHIPPING".intern();
			public static final String BILLING = "BILLING".intern();
		}
		...
		public static class OrderStatus
		{
			...
			public static final String PAYMENT_NOT_VOIDED = "PAYMENT_NOT_VOIDED".intern();
			public static final String TAX_NOT_VOIDED = "TAX_NOT_VOIDED".intern();
			public static final String TAX_NOT_COMMITTED = "TAX_NOT_COMMITTED".intern();
			public static final String TAX_NOT_REQUOTED = "TAX_NOT_REQUOTED".intern();
		}
		...
		public static class QuoteAction
		{
			...
			public static final String REQUOTE = "REQUOTE".intern();
		}
		public static class QuoteNotificationType
		{
			public static final String EXPIRING_SOON = "EXPIRING_SOON".intern();
			public static final String EXPIRED = "EXPIRED".intern();
		}
	...
	public static class Relations
	{
		...
		public static final String BASESTORE2BILLINGCOUNTRYREL = "BaseStore2BillingCountryRel".intern();
		...
		public static final String QUOTETONOTIFICATIONREL = "QuoteToNotificationRel".intern();
