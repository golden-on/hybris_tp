...
import de.hybris.platform.acceleratorcms.jalo.actions.ListAddToEntryGroupAction;
import de.hybris.platform.acceleratorcms.jalo.actions.ListOrderFormAction;
...
import de.hybris.platform.acceleratorcms.jalo.components.CategoryNavigationComponent;
...
public abstract class GeneratedAcceleratorCmsManager extends Extension
{
	...
	**/
	...
	public CategoryNavigationComponent createCategoryNavigationComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorCmsConstants.TC.CATEGORYNAVIGATIONCOMPONENT );
			return (CategoryNavigationComponent)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating CategoryNavigationComponent : "+e.getMessage(), 0 );
		}
	}
	
	public CategoryNavigationComponent createCategoryNavigationComponent(final Map attributeValues)
	{
		return createCategoryNavigationComponent( getSession().getSessionContext(), attributeValues );
	}
	...
	public FooterNavigationComponent createFooterNavigationComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorCmsConstants.TC.FOOTERNAVIGATIONCOMPONENT );
			return (FooterNavigationComponent)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating FooterNavigationComponent : "+e.getMessage(), 0 );
		}
	}
	
	public FooterNavigationComponent createFooterNavigationComponent(final Map attributeValues)
	{
		return createFooterNavigationComponent( getSession().getSessionContext(), attributeValues );
	}
	...
	public ListAddToEntryGroupAction createListAddToEntryGroupAction(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorCmsConstants.TC.LISTADDTOENTRYGROUPACTION );
			return (ListAddToEntryGroupAction)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating ListAddToEntryGroupAction : "+e.getMessage(), 0 );
		}
	}
	
	public ListAddToEntryGroupAction createListAddToEntryGroupAction(final Map attributeValues)
	{
		return createListAddToEntryGroupAction( getSession().getSessionContext(), attributeValues );
	}
	
	public ListOrderFormAction createListOrderFormAction(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorCmsConstants.TC.LISTORDERFORMACTION );
			return (ListOrderFormAction)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating ListOrderFormAction : "+e.getMessage(), 0 );
		}
	}
	
	public ListOrderFormAction createListOrderFormAction(final Map attributeValues)
	{
		return createListOrderFormAction( getSession().getSessionContext(), attributeValues );
	}
	...
	public NavigationComponent createNavigationComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorCmsConstants.TC.NAVIGATIONCOMPONENT );
			return (NavigationComponent)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating NavigationComponent : "+e.getMessage(), 0 );
		}
	}
	
	public NavigationComponent createNavigationComponent(final Map attributeValues)
	{
		return createNavigationComponent( getSession().getSessionContext(), attributeValues );
	}
