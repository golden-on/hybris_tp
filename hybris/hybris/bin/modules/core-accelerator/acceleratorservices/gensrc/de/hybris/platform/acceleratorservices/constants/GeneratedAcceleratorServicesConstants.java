...
public class GeneratedAcceleratorServicesConstants
{
	...
	public static class TC
	{
		...
		public static final String DOCUMENTPAGE = "DocumentPage".intern();
		public static final String DOCUMENTPAGETEMPLATE = "DocumentPageTemplate".intern();
		...
		public static final String IMPORTSTATUS = "ImportStatus".intern();
		public static final String ORDERMODIFICATIONPROCESS = "OrderModificationProcess".intern();
		public static final String SAVEDCARTFILEUPLOADPROCESS = "SavedCartFileUploadProcess".intern();
