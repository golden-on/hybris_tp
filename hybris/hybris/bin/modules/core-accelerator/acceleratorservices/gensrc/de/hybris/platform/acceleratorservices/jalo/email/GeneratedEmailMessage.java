...
public abstract class GeneratedEmailMessage extends GenericItem
{
	...
	**/
	...
	{
		ComposedType relationSecondEnd0 = TypeManager.getInstance().getComposedType("EmailAddress");
		if(relationSecondEnd0.isAssignableFrom(referencedItem.getComposedType()))
		{
			return Utilities.getMarkModifiedOverride(EMAILMESSAGE2TOADDRESSESREL_MARKMODIFIED);
		}
		ComposedType relationSecondEnd1 = TypeManager.getInstance().getComposedType("EmailAddress");
		...
		ComposedType relationSecondEnd2 = TypeManager.getInstance().getComposedType("EmailAddress");
