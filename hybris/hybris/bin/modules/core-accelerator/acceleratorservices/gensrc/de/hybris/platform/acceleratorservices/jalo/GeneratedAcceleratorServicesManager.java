...
import de.hybris.platform.acceleratorservices.jalo.process.SavedCartFileUploadProcess;
...
public abstract class GeneratedAcceleratorServicesManager extends Extension
{
	...
	**/
	...
	static
	{
		...
		tmp = new HashMap<String, AttributeMode>();
		tmp.put("importStatus", AttributeMode.INITIAL);
	...
	public DocumentPage createDocumentPage(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorServicesConstants.TC.DOCUMENTPAGE );
			return (DocumentPage)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating DocumentPage : "+e.getMessage(), 0 );
		}
	}
	
	public DocumentPage createDocumentPage(final Map attributeValues)
	{
		return createDocumentPage( getSession().getSessionContext(), attributeValues );
	}
	
	public DocumentPageTemplate createDocumentPageTemplate(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorServicesConstants.TC.DOCUMENTPAGETEMPLATE );
			return (DocumentPageTemplate)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating DocumentPageTemplate : "+e.getMessage(), 0 );
		}
	}
	
	public DocumentPageTemplate createDocumentPageTemplate(final Map attributeValues)
	{
		return createDocumentPageTemplate( getSession().getSessionContext(), attributeValues );
	}
	...
	public SavedCartFileUploadProcess createSavedCartFileUploadProcess(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( AcceleratorServicesConstants.TC.SAVEDCARTFILEUPLOADPROCESS );
			return (SavedCartFileUploadProcess)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating SavedCartFileUploadProcess : "+e.getMessage(), 0 );
		}
	}
	
	public SavedCartFileUploadProcess createSavedCartFileUploadProcess(final Map attributeValues)
	{
		return createSavedCartFileUploadProcess( getSession().getSessionContext(), attributeValues );
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Cart.importStatus</code> attribute.
	 * @return the importStatus - set the status of the import cart process
	 */
	public EnumerationValue getImportStatus(final SessionContext ctx, final Cart item)
	{
		return (EnumerationValue)item.getProperty( ctx, AcceleratorServicesConstants.Attributes.Cart.IMPORTSTATUS);
	}
	 ...
	 * @return the importStatus - set the status of the import cart process
	 */
	public EnumerationValue getImportStatus(final Cart item)
	{
		return getImportStatus( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Cart.importStatus</code> attribute. 
	 * @param value the importStatus - set the status of the import cart process
	 */
	public void setImportStatus(final SessionContext ctx, final Cart item, final EnumerationValue value)
	{
		item.setProperty(ctx, AcceleratorServicesConstants.Attributes.Cart.IMPORTSTATUS,value);
	}
	 ...
	 * @param value the importStatus - set the status of the import cart process
	 */
	public void setImportStatus(final Cart item, final EnumerationValue value)
	{
		setImportStatus( getSession().getSessionContext(), item, value );
	}
