...
public abstract class GeneratedMerchSynchronizationConfig extends GenericItem
{
	 ...
	 */
	protected void setBaseSite(final SessionContext ctx, final BaseSite value)
	{
		if ( ctx == null) 
		{
		...
		{
			throw new JaloInvalidParameterException( "attribute '"+BASESITE+"' is not changeable", 0 );
		}
	 ...
	 * @param value the baseSite - Base site to synchronize
	 */
	protected void setBaseSite(final BaseSite value)
	{
	 ...
	 */
	protected void setCatalog(final SessionContext ctx, final Catalog value)
	{
		if ( ctx == null) 
		{
			throw new JaloInvalidParameterException( "ctx is null", 0 );
	 ...
	 * @param value the catalog - Catalog to synchronize
	 */
	protected void setCatalog(final Catalog value)
	{
