...
/**
 * Generated class for type <code>YAcceleratorOrderManagementManager</code>.
 */
...
public abstract class GeneratedYAcceleratorOrderManagementManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, YAcceleratorOrderManagementConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, YAcceleratorOrderManagementConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return YAcceleratorOrderManagementConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, YAcceleratorOrderManagementConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, YAcceleratorOrderManagementConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, YAcceleratorOrderManagementConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, YAcceleratorOrderManagementConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
