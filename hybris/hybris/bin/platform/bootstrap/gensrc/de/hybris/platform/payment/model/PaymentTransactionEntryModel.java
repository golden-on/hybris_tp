...
public class PaymentTransactionEntryModel extends ItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>Consignment2PaymentTransactionEntryRelation</code> defining source attribute <code>consignment</code> in extension <code>warehousing</code>.</i>*/
	public static final String _CONSIGNMENT2PAYMENTTRANSACTIONENTRYRELATION = "Consignment2PaymentTransactionEntryRelation";
	...
	/** <i>Generated constant</i> - Attribute key of <code>PaymentTransactionEntry.authByPaytSrvcPrvdr</code> attribute defined at extension <code>cissapdigitalpayment</code>. */
	public static final String AUTHBYPAYTSRVCPRVDR = "authByPaytSrvcPrvdr";
	
	/** <i>Generated constant</i> - Attribute key of <code>PaymentTransactionEntry.authByAcquirer</code> attribute defined at extension <code>cissapdigitalpayment</code>. */
	public static final String AUTHBYACQUIRER = "authByAcquirer";
	
	/** <i>Generated constant</i> - Attribute key of <code>PaymentTransactionEntry.authByDigitalPaytSrvc</code> attribute defined at extension <code>cissapdigitalpayment</code>. */
	public static final String AUTHBYDIGITALPAYTSRVC = "authByDigitalPaytSrvc";
	
	/** <i>Generated constant</i> - Attribute key of <code>PaymentTransactionEntry.authStatus</code> attribute defined at extension <code>cissapdigitalpayment</code>. */
	public static final String AUTHSTATUS = "authStatus";
	
	/** <i>Generated constant</i> - Attribute key of <code>PaymentTransactionEntry.authStatusName</code> attribute defined at extension <code>cissapdigitalpayment</code>. */
	public static final String AUTHSTATUSNAME = "authStatusName";
	
	/** <i>Generated constant</i> - Attribute key of <code>PaymentTransactionEntry.consignment</code> attribute defined at extension <code>warehousing</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PaymentTransactionEntry.authByAcquirer</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 * @return the authByAcquirer
	 */
	@Accessor(qualifier = "authByAcquirer", type = Accessor.Type.GETTER)
	public String getAuthByAcquirer()
	{
		return getPersistenceContext().getPropertyValue(AUTHBYACQUIRER);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>PaymentTransactionEntry.authByDigitalPaytSrvc</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 * @return the authByDigitalPaytSrvc
	 */
	@Accessor(qualifier = "authByDigitalPaytSrvc", type = Accessor.Type.GETTER)
	public String getAuthByDigitalPaytSrvc()
	{
		return getPersistenceContext().getPropertyValue(AUTHBYDIGITALPAYTSRVC);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>PaymentTransactionEntry.authByPaytSrvcPrvdr</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 * @return the authByPaytSrvcPrvdr
	 */
	@Accessor(qualifier = "authByPaytSrvcPrvdr", type = Accessor.Type.GETTER)
	public String getAuthByPaytSrvcPrvdr()
	{
		return getPersistenceContext().getPropertyValue(AUTHBYPAYTSRVCPRVDR);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>PaymentTransactionEntry.authStatus</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 * @return the authStatus
	 */
	@Accessor(qualifier = "authStatus", type = Accessor.Type.GETTER)
	public String getAuthStatus()
	{
		return getPersistenceContext().getPropertyValue(AUTHSTATUS);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>PaymentTransactionEntry.authStatusName</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 * @return the authStatusName
	 */
	@Accessor(qualifier = "authStatusName", type = Accessor.Type.GETTER)
	public String getAuthStatusName()
	{
		return getPersistenceContext().getPropertyValue(AUTHSTATUSNAME);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PaymentTransactionEntry.consignment</code> attribute defined at extension <code>warehousing</code>. 
	...
	/**
	 * <i>Generated method</i> - Setter of <code>PaymentTransactionEntry.authByAcquirer</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 *  
	 * @param value the authByAcquirer
	 */
	@Accessor(qualifier = "authByAcquirer", type = Accessor.Type.SETTER)
	public void setAuthByAcquirer(final String value)
	{
		getPersistenceContext().setPropertyValue(AUTHBYACQUIRER, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>PaymentTransactionEntry.authByDigitalPaytSrvc</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 *  
	 * @param value the authByDigitalPaytSrvc
	 */
	@Accessor(qualifier = "authByDigitalPaytSrvc", type = Accessor.Type.SETTER)
	public void setAuthByDigitalPaytSrvc(final String value)
	{
		getPersistenceContext().setPropertyValue(AUTHBYDIGITALPAYTSRVC, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>PaymentTransactionEntry.authByPaytSrvcPrvdr</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 *  
	 * @param value the authByPaytSrvcPrvdr
	 */
	@Accessor(qualifier = "authByPaytSrvcPrvdr", type = Accessor.Type.SETTER)
	public void setAuthByPaytSrvcPrvdr(final String value)
	{
		getPersistenceContext().setPropertyValue(AUTHBYPAYTSRVCPRVDR, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>PaymentTransactionEntry.authStatus</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 *  
	 * @param value the authStatus
	 */
	@Accessor(qualifier = "authStatus", type = Accessor.Type.SETTER)
	public void setAuthStatus(final String value)
	{
		getPersistenceContext().setPropertyValue(AUTHSTATUS, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>PaymentTransactionEntry.authStatusName</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 *  
	 * @param value the authStatusName
	 */
	@Accessor(qualifier = "authStatusName", type = Accessor.Type.SETTER)
	public void setAuthStatusName(final String value)
	{
		getPersistenceContext().setPropertyValue(AUTHSTATUSNAME, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>PaymentTransactionEntry.consignment</code> attribute defined at extension <code>warehousing</code>. 
	 *  
