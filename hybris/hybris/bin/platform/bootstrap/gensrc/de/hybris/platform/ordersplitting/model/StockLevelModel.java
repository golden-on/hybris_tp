...
public class StockLevelModel extends ItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>AdvancedShippingNoticeEntry2StockLevelRelation</code> defining source attribute <code>asnEntry</code> in extension <code>warehousing</code>.</i>*/
	public static final String _ADVANCEDSHIPPINGNOTICEENTRY2STOCKLEVELRELATION = "AdvancedShippingNoticeEntry2StockLevelRelation";
	...
	/** <i>Generated constant</i> - Attribute key of <code>StockLevel.bin</code> attribute defined at extension <code>warehousing</code>. */
	public static final String BIN = "bin";
	
	/** <i>Generated constant</i> - Attribute key of <code>StockLevel.inventoryEvents</code> attribute defined at extension <code>warehousing</code>. */
	public static final String INVENTORYEVENTS = "inventoryEvents";
	
	/** <i>Generated constant</i> - Attribute key of <code>StockLevel.asnEntry</code> attribute defined at extension <code>warehousing</code>. */
	public static final String ASNENTRY = "asnEntry";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>StockLevel.asnEntry</code> attribute defined at extension <code>warehousing</code>. 
	 * @return the asnEntry
	 */
	@Accessor(qualifier = "asnEntry", type = Accessor.Type.GETTER)
	public AdvancedShippingNoticeEntryModel getAsnEntry()
	{
		return getPersistenceContext().getPropertyValue(ASNENTRY);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>StockLevel.bin</code> attribute defined at extension <code>warehousing</code>. 
	 * @return the bin
	 */
	@Accessor(qualifier = "bin", type = Accessor.Type.GETTER)
	public String getBin()
	{
		return getPersistenceContext().getPropertyValue(BIN);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>StockLevel.inventoryEvents</code> attribute defined at extension <code>warehousing</code>. 
	...
	/**
	 * <i>Generated method</i> - Setter of <code>StockLevel.asnEntry</code> attribute defined at extension <code>warehousing</code>. 
	 *  
	 * @param value the asnEntry
	 */
	@Accessor(qualifier = "asnEntry", type = Accessor.Type.SETTER)
	public void setAsnEntry(final AdvancedShippingNoticeEntryModel value)
	{
		getPersistenceContext().setPropertyValue(ASNENTRY, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>StockLevel.bin</code> attribute defined at extension <code>warehousing</code>. 
	 *  
	 * @param value the bin
	 */
	@Accessor(qualifier = "bin", type = Accessor.Type.SETTER)
	public void setBin(final String value)
	{
		getPersistenceContext().setPropertyValue(BIN, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>StockLevel.inventoryEvents</code> attribute defined at extension <code>warehousing</code>. 
	 *  
