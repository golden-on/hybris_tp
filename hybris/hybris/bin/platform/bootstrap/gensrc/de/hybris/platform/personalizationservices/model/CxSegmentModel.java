...
public class CxSegmentModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>CxSegment.description</code> attribute defined at extension <code>personalizationservices</code>. */
	public static final String DESCRIPTION = "description";
	
	/** <i>Generated constant</i> - Attribute key of <code>CxSegment.autoCreated</code> attribute defined at extension <code>personalizationservices</code>. */
	public static final String AUTOCREATED = "autoCreated";
	
	/** <i>Generated constant</i> - Attribute key of <code>CxSegment.providers</code> attribute defined at extension <code>personalizationservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxSegment.description</code> attribute defined at extension <code>personalizationservices</code>. 
	 * @return the description - Description of segment
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxSegment.providers</code> attribute defined at extension <code>personalizationservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the providers - Providers that contains segment
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxSegment.autoCreated</code> attribute defined at extension <code>personalizationservices</code>. 
	 * @return the autoCreated - Indicates if segment has been created automatically
	 */
	@Accessor(qualifier = "autoCreated", type = Accessor.Type.GETTER)
	public boolean isAutoCreated()
	{
		return toPrimitive((Boolean)getPersistenceContext().getPropertyValue(AUTOCREATED));
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>CxSegment.autoCreated</code> attribute defined at extension <code>personalizationservices</code>. 
	 *  
	 * @param value the autoCreated - Indicates if segment has been created automatically
	 */
	@Accessor(qualifier = "autoCreated", type = Accessor.Type.SETTER)
	public void setAutoCreated(final boolean value)
	{
		getPersistenceContext().setPropertyValue(AUTOCREATED, toObject(value));
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CxSegment.description</code> attribute defined at extension <code>personalizationservices</code>. 
	 *  
	 * @param value the description - Description of segment
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CxSegment.providers</code> attribute defined at extension <code>personalizationservices</code>. 
	 *  
	 * @param value the providers - Providers that contains segment
	 */
