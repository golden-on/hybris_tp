...
public class BarcodeType implements HybrisEnumValue
{
	...
	public final static String _TYPECODE = "BarcodeType";
	
	/**<i>Generated simple class name constant.</i>*/
	public final static String SIMPLE_CLASSNAME = "BarcodeType";
	private static final ConcurrentMap<String, BarcodeType> cache = new ConcurrentHashMap<String, BarcodeType>();
	/**
	...
	*/
	 ...
	 */
	private BarcodeType(final String code)
	{
	 ...
	 * if and only if the argument is not <code>null</code> and is an <code>BarcodeType
	...
	/**
	 * Returns a hash code for this <code>BarcodeType</code>.
	 *  
	 * @return a hash code value for this object, equal to the enum value <code>code</code>
	 *         represented by this <code>BarcodeType</code> object.
	 */
	@Override
	public int hashCode()
	{
	...
	/**
	 * Returns a <tt>BarcodeType</tt> instance representing the specified enum value.
	 *  
	 * @param code an enum value
	 * @return a <tt>BarcodeType</tt> instance representing <tt>value</tt>. 
	 */
	public static BarcodeType valueOf(final String code)
	{
