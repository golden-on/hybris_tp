...
public class CountryModel extends C2LItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Country.billingBaseStores</code> attribute defined at extension <code>commerceservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Country.billingBaseStores</code> attribute defined at extension <code>commerceservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	...
	{
		return getPersistenceContext().getPropertyValue(BILLINGBASESTORES);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Country.billingBaseStores</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the billingBaseStores
	 */
	@Accessor(qualifier = "billingBaseStores", type = Accessor.Type.SETTER)
	public void setBillingBaseStores(final Set<BaseStoreModel> value)
	{
