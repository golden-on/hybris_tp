...
public class AbstractRuleModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractRule.rulesModules</code> attribute defined at extension <code>ruleengineservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractRule.rulesModules</code> attribute defined at extension <code>ruleengineservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the rulesModules - List of the current deployments.
	 */
	@Accessor(qualifier = "rulesModules", type = Accessor.Type.GETTER)
	public List<AbstractRulesModuleModel> getRulesModules()
	{
		return getPersistenceContext().getPropertyValue(RULESMODULES);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractRule.rulesModules</code> attribute defined at extension <code>ruleengineservices</code>. 
	 *  
	 * @param value the rulesModules - List of the current deployments.
	 */
	@Accessor(qualifier = "rulesModules", type = Accessor.Type.SETTER)
	public void setRulesModules(final List<AbstractRulesModuleModel> value)
	{
