...
public class AsPromotedFacetModel extends AbstractAsFacetConfigurationModel
{
	...
	public AsPromotedFacetModel(final String _indexProperty, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid, final String _uniqueIdx)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsPromotedFacetModel(final CatalogVersionModel _catalogVersion, final String _indexProperty, final ItemModel _owner, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid, final String _uniqueIdx)
	{
		super();
