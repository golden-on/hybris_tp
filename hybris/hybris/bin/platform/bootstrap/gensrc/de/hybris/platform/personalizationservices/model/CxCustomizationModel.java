...
public class CxCustomizationModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>CxCustomization.longDescription</code> attribute defined at extension <code>personalizationservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxCustomization.longDescription</code> attribute defined at extension <code>personalizationservices</code>. 
	 * @return the longDescription - Long description of customization
	 */
	@Accessor(qualifier = "longDescription", type = Accessor.Type.GETTER)
	public String getLongDescription()
	{
		return getPersistenceContext().getPropertyValue(LONGDESCRIPTION);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CxCustomization.longDescription</code> attribute defined at extension <code>personalizationservices</code>. 
	 *  
	 * @param value the longDescription - Long description of customization
	 */
	@Accessor(qualifier = "longDescription", type = Accessor.Type.SETTER)
	public void setLongDescription(final String value)
	{
		getPersistenceContext().setPropertyValue(LONGDESCRIPTION, value);
	}
