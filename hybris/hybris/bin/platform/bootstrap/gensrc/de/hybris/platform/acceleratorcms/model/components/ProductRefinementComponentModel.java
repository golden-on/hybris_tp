...
public class ProductRefinementComponentModel extends SimpleCMSComponentModel
{
	 ...
	 */
	public ProductRefinementComponentModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public ProductRefinementComponentModel(final CatalogVersionModel _catalogVersion, final String _uid)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public ProductRefinementComponentModel(final CatalogVersionModel _catalogVersion, final ItemModel _owner, final String _uid)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setOwner(_owner);
