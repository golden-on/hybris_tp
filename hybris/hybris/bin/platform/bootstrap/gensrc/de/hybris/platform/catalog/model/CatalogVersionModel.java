...
public class CatalogVersionModel extends ItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>MerchProductDir2CatalogVersion</code> defining source attribute <code>merchProductDirectoryConfig</code> in extension <code>merchandisingservices</code>.</i>*/
	public static final String _MERCHPRODUCTDIR2CATALOGVERSION = "MerchProductDir2CatalogVersion";
	
	/**<i>Generated relation code constant for relation <code>MerchIndexingConfig2CatalogVersion</code> defining source attribute <code>merchIndexingConfig</code> in extension <code>merchandisingservices</code>.</i>*/
	public static final String _MERCHINDEXINGCONFIG2CATALOGVERSION = "MerchIndexingConfig2CatalogVersion";
	...
	/** <i>Generated constant</i> - Attribute key of <code>CatalogVersion.workflowTemplates</code> attribute defined at extension <code>cms2</code>. */
	public static final String WORKFLOWTEMPLATES = "workflowTemplates";
	
	/** <i>Generated constant</i> - Attribute key of <code>CatalogVersion.merchProductDirectoryConfig</code> attribute defined at extension <code>merchandisingservices</code>. */
	public static final String MERCHPRODUCTDIRECTORYCONFIG = "merchProductDirectoryConfig";
	
	/** <i>Generated constant</i> - Attribute key of <code>CatalogVersion.merchIndexingConfig</code> attribute defined at extension <code>merchandisingservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CatalogVersion.merchIndexingConfig</code> attribute defined at extension <code>merchandisingservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the merchIndexingConfig
	 */
	@Accessor(qualifier = "merchIndexingConfig", type = Accessor.Type.GETTER)
	public Collection<MerchIndexingConfigModel> getMerchIndexingConfig()
	{
		return getPersistenceContext().getPropertyValue(MERCHINDEXINGCONFIG);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>CatalogVersion.merchProductDirectoryConfig</code> attribute defined at extension <code>merchandisingservices</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the merchProductDirectoryConfig
	 */
	@Accessor(qualifier = "merchProductDirectoryConfig", type = Accessor.Type.GETTER)
	public Collection<MerchProductDirectoryConfigModel> getMerchProductDirectoryConfig()
	{
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CatalogVersion.workflowTemplates</code> attribute defined at extension <code>cms2</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	...
	{
		return getPersistenceContext().getPropertyValue(WORKFLOWTEMPLATES);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CatalogVersion.merchIndexingConfig</code> attribute defined at extension <code>merchandisingservices</code>. 
	 *  
	 * @param value the merchIndexingConfig
	 */
	@Accessor(qualifier = "merchIndexingConfig", type = Accessor.Type.SETTER)
	public void setMerchIndexingConfig(final Collection<MerchIndexingConfigModel> value)
	{
		getPersistenceContext().setPropertyValue(MERCHINDEXINGCONFIG, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>CatalogVersion.merchProductDirectoryConfig</code> attribute defined at extension <code>merchandisingservices</code>. 
	 *  
	 * @param value the merchProductDirectoryConfig
	 */
	@Accessor(qualifier = "merchProductDirectoryConfig", type = Accessor.Type.SETTER)
	public void setMerchProductDirectoryConfig(final Collection<MerchProductDirectoryConfigModel> value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CatalogVersion.workflowTemplates</code> attribute defined at extension <code>cms2</code>. 
	 *  
	 * @param value the workflowTemplates
	 */
	@Accessor(qualifier = "workflowTemplates", type = Accessor.Type.SETTER)
	public void setWorkflowTemplates(final Collection<WorkflowTemplateModel> value)
	{
