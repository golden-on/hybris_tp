 ...
 */
package de.hybris.platform.stocknotificationservices.model;
...
public class StockNotificationProcessModel extends ProductInterestsProcessModel
{
	...
	public static final String _TYPECODE = "StockNotificationProcess";
	 ...
	 */
	public StockNotificationProcessModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public StockNotificationProcessModel(final String _code, final String _processDefinitionName)
	{
		super();
		setCode(_code);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public StockNotificationProcessModel(final String _code, final ItemModel _owner, final String _processDefinitionName)
	{
		super();
		setCode(_code);
		setOwner(_owner);
