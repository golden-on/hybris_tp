...
public class AllocationEventModel extends InventoryEventModel
{
	...
	public static final String _TYPECODE = "AllocationEvent";
	 ...
	 */
	public AllocationEventModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public AllocationEventModel(final StockLevelModel _stockLevel)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AllocationEventModel(final ItemModel _owner, final StockLevelModel _stockLevel)
	{
		super();
		setOwner(_owner);
		setStockLevel(_stockLevel);
