...
public class AsPromotedFacetValueModel extends AbstractAsFacetValueConfigurationModel
{
	...
	public AsPromotedFacetValueModel(final AbstractAsFacetConfigurationModel _facetConfiguration, final String _uid, final String _uniqueIdx, final String _value)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsPromotedFacetValueModel(final CatalogVersionModel _catalogVersion, final AbstractAsFacetConfigurationModel _facetConfiguration, final ItemModel _owner, final String _uid, final String _uniqueIdx, final String _value)
	{
		super();
