...
public class WastageEventModel extends InventoryEventModel
{
	/**<i>Generated model type code constant.</i>*/
	public static final String _TYPECODE = "WastageEvent";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public WastageEventModel()
	{
		super();
	}
	 ...
	 */
	public WastageEventModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public WastageEventModel(final StockLevelModel _stockLevel)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public WastageEventModel(final ItemModel _owner, final StockLevelModel _stockLevel)
	{
		super();
		setOwner(_owner);
		setStockLevel(_stockLevel);
