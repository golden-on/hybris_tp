...
public class AbstractAsConfigurationModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractAsConfiguration.corrupted</code> attribute defined at extension <code>adaptivesearch</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractAsConfiguration.corrupted</code> dynamic attribute defined at extension <code>adaptivesearch</code>. 
	 * @return the corrupted
	 */
	@Accessor(qualifier = "corrupted", type = Accessor.Type.GETTER)
	public boolean isCorrupted()
	{
		return toPrimitive( (Boolean) getPersistenceContext().getDynamicValue(this,CORRUPTED));
	}
