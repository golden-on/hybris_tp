 ...
 * <p>
 * Represents the suggestion component that displays product references for each item in the cart.
 */
...
public class CartSuggestionComponentModel extends SimpleSuggestionComponentModel
{
	 ...
	 */
	public CartSuggestionComponentModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public CartSuggestionComponentModel(final CatalogVersionModel _catalogVersion, final String _uid)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public CartSuggestionComponentModel(final CatalogVersionModel _catalogVersion, final ItemModel _owner, final String _uid)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setOwner(_owner);
