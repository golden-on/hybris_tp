...
public class ProductModel extends ItemModel
{
	...
	/**<i>Generated relation code constant for relation <code>FutureStockProductRelation</code> defining source attribute <code>futureStocks</code> in extension <code>b2bcommerce</code>.</i>*/
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.reviewCount</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String REVIEWCOUNT = "reviewCount";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.reviewRating</code> attribute defined at extension <code>commerceservices</code>. */
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.futureStocks</code> attribute defined at extension <code>b2bcommerce</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.futureStocks</code> attribute defined at extension <code>b2bcommerce</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	...
	{
		return getPersistenceContext().getPropertyValue(FUTURESTOCKS);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.reviewCount</code> attribute defined at extension <code>commerceservices</code>. 
	...
	{
		return getPersistenceContext().getPropertyValue(REVIEWCOUNT);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.reviewRating</code> attribute defined at extension <code>commerceservices</code>. 
	...
	{
		return getPersistenceContext().getPropertyValue(REVIEWRATING);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.futureStocks</code> attribute defined at extension <code>b2bcommerce</code>. 
	 *  
	 * @param value the futureStocks
	 */
	@Accessor(qualifier = "futureStocks", type = Accessor.Type.SETTER)
	public void setFutureStocks(final Set<FutureStockModel> value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.reviewCount</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	...
	public void setReviewCount(final Integer value)
	{
		getPersistenceContext().setPropertyValue(REVIEWCOUNT, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>Product.reviewRating</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	...
	public void setReviewRating(final Double value)
	{
