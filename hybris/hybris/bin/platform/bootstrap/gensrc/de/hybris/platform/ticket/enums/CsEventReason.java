...
public class CsEventReason implements HybrisEnumValue
{
	...
	public final static String _TYPECODE = "CsEventReason";
	
	/**<i>Generated simple class name constant.</i>*/
	public final static String SIMPLE_CLASSNAME = "CsEventReason";
	private static final ConcurrentMap<String, CsEventReason> cache = new ConcurrentHashMap<String, CsEventReason>();
	/**
	...
	*/
	 ...
	 */
	private CsEventReason(final String code)
	{
	 ...
	 * if and only if the argument is not <code>null</code> and is an <code>CsEventReason
	...
	/**
	 * Returns a hash code for this <code>CsEventReason</code>.
	 *  
	 * @return a hash code value for this object, equal to the enum value <code>code</code>
	 *         represented by this <code>CsEventReason</code> object.
	 */
	@Override
	public int hashCode()
	{
	...
	/**
	 * Returns a <tt>CsEventReason</tt> instance representing the specified enum value.
	 *  
	 * @param code an enum value
	 * @return a <tt>CsEventReason</tt> instance representing <tt>value</tt>. 
	 */
	public static CsEventReason valueOf(final String code)
	{
