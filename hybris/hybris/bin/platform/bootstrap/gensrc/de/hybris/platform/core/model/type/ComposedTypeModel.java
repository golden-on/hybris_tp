...
public class ComposedTypeModel extends TypeModel
{
	...
	/**<i>Generated relation code constant for relation <code>StreamConfigurationExcludedSubtypes</code> defining source attribute <code>streamConfigurations</code> in extension <code>deltadetection</code>.</i>*/
	...
	/** <i>Generated constant</i> - Attribute key of <code>ComposedType.streamConfigurations</code> attribute defined at extension <code>deltadetection</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ComposedType.streamConfigurations</code> attribute defined at extension <code>deltadetection</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the streamConfigurations
	 */
	...
	{
		return getPersistenceContext().getPropertyValue(STREAMCONFIGURATIONS);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ComposedType.streamConfigurations</code> attribute defined at extension <code>deltadetection</code>. 
	 *  
	 * @param value the streamConfigurations
	 */
	@Accessor(qualifier = "streamConfigurations", type = Accessor.Type.SETTER)
	public void setStreamConfigurations(final Collection<StreamConfigurationModel> value)
	{
