 ...
 * <p>
 * An inventory increase event.
 */
@SuppressWarnings("all")
public class IncreaseEventModel extends InventoryEventModel
{
	/**<i>Generated model type code constant.</i>*/
	public static final String _TYPECODE = "IncreaseEvent";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public IncreaseEventModel()
	{
		super();
	}
	 ...
	 */
	public IncreaseEventModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public IncreaseEventModel(final StockLevelModel _stockLevel)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public IncreaseEventModel(final ItemModel _owner, final StockLevelModel _stockLevel)
	{
		super();
		setOwner(_owner);
		setStockLevel(_stockLevel);
