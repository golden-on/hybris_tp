...
public class BaseStoreModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>BaseStore.ondemandBaseStorePreferences</code> attribute defined at extension <code>ondemandcommon</code>. */
	public static final String ONDEMANDBASESTOREPREFERENCES = "ondemandBaseStorePreferences";
	...
	/** <i>Generated constant</i> - Attribute key of <code>BaseStore.sapDigitalPaymentConfiguration</code> attribute defined at extension <code>cissapdigitalpayment</code>. */
	public static final String SAPDIGITALPAYMENTCONFIGURATION = "sapDigitalPaymentConfiguration";
	
	/** <i>Generated constant</i> - Attribute key of <code>BaseStore.defaultAtpFormula</code> attribute defined at extension <code>warehousing</code>. */
	public static final String DEFAULTATPFORMULA = "defaultAtpFormula";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.defaultAtpFormula</code> attribute defined at extension <code>warehousing</code>. 
	 * @return the defaultAtpFormula
	 */
	@Accessor(qualifier = "defaultAtpFormula", type = Accessor.Type.GETTER)
	public AtpFormulaModel getDefaultAtpFormula()
	{
		return getPersistenceContext().getPropertyValue(DEFAULTATPFORMULA);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.ondemandBaseStorePreferences</code> attribute defined at extension <code>ondemandcommon</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the ondemandBaseStorePreferences
	 */
	@Accessor(qualifier = "ondemandBaseStorePreferences", type = Accessor.Type.GETTER)
	public List<OndemandBaseStorePreferenceModel> getOndemandBaseStorePreferences()
	{
		return getPersistenceContext().getPropertyValue(ONDEMANDBASESTOREPREFERENCES);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.sapDigitalPaymentConfiguration</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 * @return the sapDigitalPaymentConfiguration
	 */
	@Accessor(qualifier = "sapDigitalPaymentConfiguration", type = Accessor.Type.GETTER)
	public SAPDigitalPaymentConfigurationModel getSapDigitalPaymentConfiguration()
	{
		return getPersistenceContext().getPropertyValue(SAPDIGITALPAYMENTCONFIGURATION);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BaseStore.sourcingConfig</code> attribute defined at extension <code>warehousing</code>. 
	 * @return the sourcingConfig
	 */
	@Accessor(qualifier = "sourcingConfig", type = Accessor.Type.GETTER)
	public SourcingConfigModel getSourcingConfig()
	{
		return getPersistenceContext().getPropertyValue(SOURCINGCONFIG);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.defaultAtpFormula</code> attribute defined at extension <code>warehousing</code>. 
	 *  
	 * @param value the defaultAtpFormula
	 */
	@Accessor(qualifier = "defaultAtpFormula", type = Accessor.Type.SETTER)
	public void setDefaultAtpFormula(final AtpFormulaModel value)
	{
		getPersistenceContext().setPropertyValue(DEFAULTATPFORMULA, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.ondemandBaseStorePreferences</code> attribute defined at extension <code>ondemandcommon</code>. 
	 *  
	 * @param value the ondemandBaseStorePreferences
	 */
	@Accessor(qualifier = "ondemandBaseStorePreferences", type = Accessor.Type.SETTER)
	public void setOndemandBaseStorePreferences(final List<OndemandBaseStorePreferenceModel> value)
	{
		getPersistenceContext().setPropertyValue(ONDEMANDBASESTOREPREFERENCES, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.sapDigitalPaymentConfiguration</code> attribute defined at extension <code>cissapdigitalpayment</code>. 
	 *  
	 * @param value the sapDigitalPaymentConfiguration
	 */
	@Accessor(qualifier = "sapDigitalPaymentConfiguration", type = Accessor.Type.SETTER)
	public void setSapDigitalPaymentConfiguration(final SAPDigitalPaymentConfigurationModel value)
	{
		getPersistenceContext().setPropertyValue(SAPDIGITALPAYMENTCONFIGURATION, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BaseStore.sourcingConfig</code> attribute defined at extension <code>warehousing</code>. 
	 *  
	 * @param value the sourcingConfig
	 */
	@Accessor(qualifier = "sourcingConfig", type = Accessor.Type.SETTER)
	public void setSourcingConfig(final SourcingConfigModel value)
	{
		getPersistenceContext().setPropertyValue(SOURCINGCONFIG, value);
	}
