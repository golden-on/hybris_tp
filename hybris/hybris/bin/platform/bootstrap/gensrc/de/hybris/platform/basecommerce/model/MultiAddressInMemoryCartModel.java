...
public class MultiAddressInMemoryCartModel extends InMemoryCartModel
{
	 ...
	 */
	public MultiAddressInMemoryCartModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	...
	public MultiAddressInMemoryCartModel(final CurrencyModel _currency, final Date _date, final UserModel _user)
	{
		super();
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public MultiAddressInMemoryCartModel(final CurrencyModel _currency, final Date _date, final ItemModel _owner, final UserModel _user)
	{
		super();
		setCurrency(_currency);
		setDate(_date);
