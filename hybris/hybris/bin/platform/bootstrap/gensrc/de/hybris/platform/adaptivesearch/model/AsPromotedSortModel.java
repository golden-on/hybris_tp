...
public class AsPromotedSortModel extends AbstractAsSortConfigurationModel
{
	...
	public AsPromotedSortModel(final String _code, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid, final String _uniqueIdx)
	{
		super();
		setCode(_code);
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public AsPromotedSortModel(final CatalogVersionModel _catalogVersion, final String _code, final ItemModel _owner, final AbstractAsConfigurableSearchConfigurationModel _searchConfiguration, final String _uid, final String _uniqueIdx)
	{
		super();
