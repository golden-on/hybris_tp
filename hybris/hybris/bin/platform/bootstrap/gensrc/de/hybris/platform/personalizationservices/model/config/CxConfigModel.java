...
public class CxConfigModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>CxConfig.autoCreateSegments</code> attribute defined at extension <code>personalizationintegration</code>. */
	public static final String AUTOCREATESEGMENTS = "autoCreateSegments";
	...
	/** <i>Generated constant</i> - Attribute key of <code>CxConfig.orderMapperSegmentMap</code> attribute defined at extension <code>personalizationyprofile</code>. */
	public static final String ORDERMAPPERSEGMENTMAP = "orderMapperSegmentMap";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxConfig.autoCreateSegments</code> attribute defined at extension <code>personalizationintegration</code>. 
	 * @return the autoCreateSegments - If set to true segments are automatically created from external data during update.
	 */
	@Accessor(qualifier = "autoCreateSegments", type = Accessor.Type.GETTER)
	public Boolean getAutoCreateSegments()
	{
		return getPersistenceContext().getPropertyValue(AUTOCREATESEGMENTS);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxConfig.orderMapperSegmentMap</code> attribute defined at extension <code>personalizationyprofile</code>. 
	 * @return the orderMapperSegmentMap - Map with configuration for OrderMapper
	 */
	@Accessor(qualifier = "orderMapperSegmentMap", type = Accessor.Type.GETTER)
	public Map<String,BigDecimal> getOrderMapperSegmentMap()
	{
		return getPersistenceContext().getPropertyValue(ORDERMAPPERSEGMENTMAP);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CxConfig.autoCreateSegments</code> attribute defined at extension <code>personalizationintegration</code>. 
	 *  
	 * @param value the autoCreateSegments - If set to true segments are automatically created from external data during update.
	 */
	@Accessor(qualifier = "autoCreateSegments", type = Accessor.Type.SETTER)
	public void setAutoCreateSegments(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(AUTOCREATESEGMENTS, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CxConfig.orderMapperSegmentMap</code> attribute defined at extension <code>personalizationyprofile</code>. 
	 *  
	 * @param value the orderMapperSegmentMap - Map with configuration for OrderMapper
	 */
	@Accessor(qualifier = "orderMapperSegmentMap", type = Accessor.Type.SETTER)
	public void setOrderMapperSegmentMap(final Map<String,BigDecimal> value)
	{
		getPersistenceContext().setPropertyValue(ORDERMAPPERSEGMENTMAP, value);
	}
