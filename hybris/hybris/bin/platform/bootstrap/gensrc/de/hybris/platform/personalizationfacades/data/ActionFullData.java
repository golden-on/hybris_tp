 ...
 * Action Full Data
 */
@ApiModel(value="action", description="Action Full Data")
public  class ActionFullData  implements Serializable 
{
	...
	@ApiModelProperty(name="customizationCode") 	
	...
	@ApiModelProperty(name="customizationName") 	
	...
	@ApiModelProperty(name="customizationStatus") 	
	...
	@ApiModelProperty(name="customizationRank") 	
	...
	@ApiModelProperty(name="variationCode") 	
	...
	@ApiModelProperty(name="variationName") 	
	...
	@ApiModelProperty(name="variationStatus") 	
	...
	@ApiModelProperty(name="variationRank") 	
	...
	@ApiModelProperty(name="actionCatalog") 	
	...
	@ApiModelProperty(name="actionCatalogVersion") 	
	...
	@ApiModelProperty(name="actionRank") 	
