...
public class CxResultsModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>CxResults.additionalData</code> attribute defined at extension <code>personalizationservices</code>. */
	...
	/** <i>Generated constant</i> - Attribute key of <code>CxResults.default</code> attribute defined at extension <code>personalizationservices</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxResults.additionalData</code> attribute defined at extension <code>personalizationservices</code>. 
	 * @return the additionalData
	 */
	@Accessor(qualifier = "additionalData", type = Accessor.Type.GETTER)
	public Object getAdditionalData()
	{
		return getPersistenceContext().getPropertyValue(ADDITIONALDATA);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CxResults.default</code> attribute defined at extension <code>personalizationservices</code>. 
	 * @return the default - Mark for default results calculated for anonymous user
	 */
	@Accessor(qualifier = "default", type = Accessor.Type.GETTER)
	public boolean isDefault()
	{
		return toPrimitive((Boolean)getPersistenceContext().getPropertyValue(DEFAULT));
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>CxResults.additionalData</code> attribute defined at extension <code>personalizationservices</code>. 
	 *  
	 * @param value the additionalData
	 */
	@Accessor(qualifier = "additionalData", type = Accessor.Type.SETTER)
	public void setAdditionalData(final Object value)
	{
		getPersistenceContext().setPropertyValue(ADDITIONALDATA, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CxResults.default</code> attribute defined at extension <code>personalizationservices</code>. 
	 *  
	 * @param value the default - Mark for default results calculated for anonymous user
	 */
	@Accessor(qualifier = "default", type = Accessor.Type.SETTER)
	public void setDefault(final boolean value)
	{
		getPersistenceContext().setPropertyValue(DEFAULT, toObject(value));
	}
