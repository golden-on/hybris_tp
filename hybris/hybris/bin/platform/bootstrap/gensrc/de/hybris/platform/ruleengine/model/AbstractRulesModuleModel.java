...
public class AbstractRulesModuleModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractRulesModule.lockAcquired</code> attribute defined at extension <code>ruleengine</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractRulesModule.lockAcquired</code> attribute defined at extension <code>ruleengine</code>. 
	 * @return the lockAcquired - Lock indicator used to indicate whether module is taking part in a blocking type operation.
	 */
	@Accessor(qualifier = "lockAcquired", type = Accessor.Type.GETTER)
	public Boolean getLockAcquired()
	{
		return getPersistenceContext().getPropertyValue(LOCKACQUIRED);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractRulesModule.lockAcquired</code> attribute defined at extension <code>ruleengine</code>. 
	 *  
	 * @param value the lockAcquired - Lock indicator used to indicate whether module is taking part in a blocking type operation.
	 */
	@Accessor(qualifier = "lockAcquired", type = Accessor.Type.SETTER)
	public void setLockAcquired(final Boolean value)
	{
