...
public class DeliveryStatus implements HybrisEnumValue
{
	...
	public final static String _TYPECODE = "DeliveryStatus";
	
	/**<i>Generated simple class name constant.</i>*/
	public final static String SIMPLE_CLASSNAME = "DeliveryStatus";
	private static final ConcurrentMap<String, DeliveryStatus> cache = new ConcurrentHashMap<String, DeliveryStatus>();
	/**
	...
	*/
	 ...
	 */
	private DeliveryStatus(final String code)
	{
	 ...
	 * if and only if the argument is not <code>null</code> and is an <code>DeliveryStatus
	...
	/**
	 * Returns a hash code for this <code>DeliveryStatus</code>.
	 *  
	 * @return a hash code value for this object, equal to the enum value <code>code</code>
	 *         represented by this <code>DeliveryStatus</code> object.
	 */
	@Override
	public int hashCode()
	{
	...
	/**
	 * Returns a <tt>DeliveryStatus</tt> instance representing the specified enum value.
	 *  
	 * @param code an enum value
	 * @return a <tt>DeliveryStatus</tt> instance representing <tt>value</tt>. 
	 */
	public static DeliveryStatus valueOf(final String code)
	{
