...
public class PriceRowChannel implements HybrisEnumValue
{
	...
	private static final ConcurrentMap<String, PriceRowChannel> cache = new ConcurrentHashMap<String, PriceRowChannel>();
	/**
	...
	*/
	 ...
	 */
	private PriceRowChannel(final String code)
	{
	 ...
	 * if and only if the argument is not <code>null</code> and is an <code>PriceRowChannel
	 ...
	 *         represented by this <code>PriceRowChannel</code> object.
	 */
	@Override
	public int hashCode()
	{
	 ...
	 */
	public static PriceRowChannel valueOf(final String code)
	{
