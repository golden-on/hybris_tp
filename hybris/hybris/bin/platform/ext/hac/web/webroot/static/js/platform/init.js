$(function() {
    ...
    $('#allProjectDataCheckbox').click(selectAllProjectData);
	...
	var prepareInitUpdateData = function() {
		...
		postData.patches = {}
        postData.createProjectData = $('#allProjectDataCheckbox').is(':checked') ? true: false;
    ...
    function selectAllProjectData() {
        var checked = $('#allProjectDataCheckbox').is(':checked') ? true : false;

        $('#toggleAll').prop('checked', false);
        $('#toggleAll').prop('disabled', checked);
			...
			success: function(data) {
				if (data.isInitializing) {
					...
					if (type === "UPDATE") {
                        ...
                        $('#allProjectDataCheckbox').attr('checked', false);
						toggleProjectData();
					}
					else {
                        $('#allProjectDataCheckbox').attr('checked', true);
