...
CREATE CACHED TABLE abstractbundler6307sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6307Sn ON abstractbundler6307sn (ITEMPK);


CREATE CACHED TABLE abstractbundlerules
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    ...
    p_price DECIMAL(30,8),
    p_currency BIGINT,
    p_bundletemplate BIGINT,
    PRIMARY KEY (PK)
);

CREATE INDEX versionIdx_6307 ON abstractbundlerules (p_catalogversion);

CREATE INDEX idVersionIdx_6307 ON abstractbundlerules (p_id, p_catalogversion);

CREATE INDEX bundletemplateRelIDX_6307 ON abstractbundlerules (p_bundletemplate);
...
CREATE INDEX IdxITEMPK_6511Sn ON asn6511sn (ITEMPK);
...
CREATE CACHED TABLE asnentry6516sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6516Sn ON asnentry6516sn (ITEMPK);
...
CREATE CACHED TABLE atpformulas6509sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6509Sn ON atpformulas6509sn (ITEMPK);
...
(
    ...
    p_captchacheckenabled TINYINT,
    p_sapdigitalpaymentconfigurati BIGINT,
...
CREATE INDEX sapdigitalpaymentconfiguratiRelIDX_2013 ON basestore (p_sapdigitalpaymentconfigurati);
...
CREATE CACHED TABLE bundlerule2cond6301sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6301Sn ON bundlerule2cond6301sn (ITEMPK);

CREATE INDEX IdxsourcePK_6301Sn ON bundlerule2cond6301sn (sourcePK);

CREATE INDEX IdxtargetPK_6301Sn ON bundlerule2cond6301sn (targetPK);

CREATE INDEX IdxlanguagePK_6301Sn ON bundlerule2cond6301sn (languagePK);


CREATE CACHED TABLE bundlerule2condprodrel
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_6301 ON bundlerule2condprodrel (RSequenceNumber);

CREATE INDEX linksource_6301 ON bundlerule2condprodrel (SourcePK);

CREATE INDEX seqnr_6301 ON bundlerule2condprodrel (SequenceNumber);

CREATE INDEX qualifier_6301 ON bundlerule2condprodrel (Qualifier);

CREATE INDEX linktarget_6301 ON bundlerule2condprodrel (TargetPK);


CREATE CACHED TABLE bundlerule2targ6302sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6302Sn ON bundlerule2targ6302sn (ITEMPK);

CREATE INDEX IdxsourcePK_6302Sn ON bundlerule2targ6302sn (sourcePK);

CREATE INDEX IdxtargetPK_6302Sn ON bundlerule2targ6302sn (targetPK);

CREATE INDEX IdxlanguagePK_6302Sn ON bundlerule2targ6302sn (languagePK);


CREATE CACHED TABLE bundlerule2targprodrel
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_6302 ON bundlerule2targprodrel (RSequenceNumber);

CREATE INDEX linksource_6302 ON bundlerule2targprodrel (SourcePK);

CREATE INDEX seqnr_6302 ON bundlerule2targprodrel (SequenceNumber);

CREATE INDEX qualifier_6302 ON bundlerule2targprodrel (Qualifier);

CREATE INDEX linktarget_6302 ON bundlerule2targprodrel (TargetPK);


CREATE CACHED TABLE bundleselection6310sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6310Sn ON bundleselection6310sn (ITEMPK);


CREATE CACHED TABLE bundleselectioncriteria
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX versionIdx_6310 ON bundleselectioncriteria (p_catalogversion);

CREATE INDEX idVersionIdx_6310 ON bundleselectioncriteria (p_id, p_catalogversion);


CREATE CACHED TABLE bundletemplates
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_catalogversion BIGINT,
    p_bundleselectioncriteria BIGINT,
    p_parenttemplatepos INTEGER,
    p_parenttemplate BIGINT,
    p_status BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE INDEX versionIdx_6309 ON bundletemplates (p_catalogversion);

CREATE INDEX idVersionIdx_6309 ON bundletemplates (p_id, p_version, p_catalogversion);

CREATE INDEX parenttemplateRelIDX_6309 ON bundletemplates (p_parenttemplate);

CREATE INDEX parenttemplateposPosIDX_6309 ON bundletemplates (p_parenttemplatepos);

CREATE INDEX statusRelIDX_6309 ON bundletemplates (p_status);


CREATE CACHED TABLE bundletemplates6309sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6309Sn ON bundletemplates6309sn (ITEMPK);


CREATE CACHED TABLE bundletemplates6311sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6311Sn ON bundletemplates6311sn (ITEMPK);


CREATE CACHED TABLE bundletemplateslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE bundletemplatestatus
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX versionIdx_6311 ON bundletemplatestatus (p_catalogversion);

CREATE INDEX idVersionIdx_6311 ON bundletemplatestatus (p_id, p_catalogversion);
...
CREATE CACHED TABLE carrier9866sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9866Sn ON carrier9866sn (ITEMPK);


CREATE CACHED TABLE carrierlp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
(
    ...
    p_costcenter BIGINT,
    p_lastmodifiedmastercart BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE INDEX lastmodifiedmastercartRelIDX_44 ON cartentries (p_lastmodifiedmastercart);
...
(
    ...
    p_deliveryfromaddress BIGINT,
    p_consentreference NVARCHAR(255),
    p_cartidreference NVARCHAR(255),
...
CREATE CACHED TABLE cat2yformdefrel
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_6343 ON cat2yformdefrel (RSequenceNumber);

CREATE INDEX linksource_6343 ON cat2yformdefrel (SourcePK);

CREATE INDEX seqnr_6343 ON cat2yformdefrel (SequenceNumber);

CREATE INDEX qualifier_6343 ON cat2yformdefrel (Qualifier);

CREATE INDEX linktarget_6343 ON cat2yformdefrel (TargetPK);


CREATE CACHED TABLE cat2yformdefrel6343sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6343Sn ON cat2yformdefrel6343sn (ITEMPK);

CREATE INDEX IdxsourcePK_6343Sn ON cat2yformdefrel6343sn (sourcePK);

CREATE INDEX IdxtargetPK_6343Sn ON cat2yformdefrel6343sn (targetPK);

CREATE INDEX IdxlanguagePK_6343Sn ON cat2yformdefrel6343sn (languagePK);
...
(
    ...
    p_layout BIGINT,
    p_productcode NVARCHAR(255),
    p_applicationid NVARCHAR(255),
    p_formid NVARCHAR(255),
    p_formdataid NVARCHAR(255),
    p_action BIGINT,
    ...
    p_pag0 NVARCHAR(255),
    p_logo BIGINT,
    p_numbertodisplay INTEGER,
    p_strategy NVARCHAR(255),
    p_backgroundcolour NVARCHAR(255),
    p_textcolour NVARCHAR(255),
    p_viewportpercentage INTEGER,
    PRIMARY KEY (PK)
);
...
(
    ...
    p_solrfacetsearchconfiguration BIGINT,
    p_merchproductdirectoryconfigp INTEGER,
    p_merchproductdirectoryconfig BIGINT,
...
CREATE INDEX merchproductdirectoryconfigRelIDX_1064 ON cmssite (p_merchproductdirectoryconfig);

CREATE INDEX merchproductdirectoryconfigpPosIDX_1064 ON cmssite (p_merchproductdirectoryconfigp);
...
CREATE CACHED TABLE cmsworkflowcomm1110sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1110Sn ON cmsworkflowcomm1110sn (ITEMPK);


CREATE CACHED TABLE cmsworkflowcomment
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE consentryevent3006sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_3006Sn ON consentryevent3006sn (ITEMPK);
...
(
    ...
    p_order BIGINT,
    p_deliverypointofservice BIGINT,
    p_carrierdetails BIGINT,
    p_packaginginfo BIGINT,
    p_shippinglabel BIGINT,
    p_returnlabel BIGINT,
    p_returnform BIGINT,
    p_taskassignmentworkflow NVARCHAR(255),
    p_fulfillmentsystemconfig LONGVARBINARY,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
(
    ...
    p_anonymous TINYINT,
    p_allproviders TINYINT,
    p_providers LONGVARBINARY,
    p_fullupdate TINYINT,
    p_allbasesites TINYINT,
    ...
    p_lastfraudreportendtime TIMESTAMP,
    p_age INTEGER,
...
(
    ...
    p_autocreatesegments TINYINT,
    p_containercleanupenabled TINYINT,
    p_ordermappersegmentmap LONGVARBINARY,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
(
    ...
    p_additionaldata LONGVARBINARY,
...
(
    ...
    p_template TINYINT,
    p_registrationstatus BIGINT,
    p_registrationstatusinfo NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
(
    ...
    p_testintegrationitemref BIGINT,
    PRIMARY KEY (PK)
);
...
CREATE INDEX testintegrationitemrefRelIDX_91 ON enumerationvalues (p_testintegrationitemref);
...
CREATE CACHED TABLE excltypesrel
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE excltypesrel8103sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8103Sn ON excltypesrel8103sn (ITEMPK);

CREATE INDEX IdxsourcePK_8103Sn ON excltypesrel8103sn (sourcePK);

CREATE INDEX IdxtargetPK_8103Sn ON excltypesrel8103sn (targetPK);

CREATE INDEX IdxlanguagePK_8103Sn ON excltypesrel8103sn (languagePK);
...
CREATE UNIQUE INDEX idx_integrationObjectItemCodeIntObj_8401 ON integrationobjitems (p_code, p_integrationobject);
...
CREATE UNIQUE INDEX idx_integrationObjectCode_8400 ON integrationobjs (p_code);
...
CREATE CACHED TABLE inventoryevents6501sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6501Sn ON inventoryevents6501sn (ITEMPK);
...
CREATE CACHED TABLE itemversionmark8100sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8100Sn ON itemversionmark8100sn (ITEMPK);


CREATE CACHED TABLE itemversionmarkers
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_itempk BIGINT,
    p_itemcomposedtype BIGINT,
    p_versionts TIMESTAMP,
    p_versionvalue NVARCHAR(255),
    p_lastversionvalue NVARCHAR(255),
    p_info NVARCHAR(255),
    p_streamid NVARCHAR(255),
    p_status BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
(
    ...
    p_output BIGINT,
    p_input BIGINT,
    p_destinationtargetid NVARCHAR(255),
    p_maxthreads INTEGER,
...
CREATE CACHED TABLE merchbaseproper2503sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2503Sn ON merchbaseproper2503sn (ITEMPK);


CREATE CACHED TABLE merchbaseproperty
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_merchmappedname NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    p_merchproductdirectoryconfigp INTEGER,
    p_merchproductdirectoryconfig BIGINT,
    p_merchindexingconfigpos INTEGER,
    p_merchindexingconfig BIGINT,
    PRIMARY KEY (PK)
);

CREATE INDEX merchproductdirectoryconfigRelIDX_2503 ON merchbaseproperty (p_merchproductdirectoryconfig);

CREATE INDEX merchproductdirectoryconfigpPosIDX_2503 ON merchbaseproperty (p_merchproductdirectoryconfigp);

CREATE INDEX merchindexingconfigRelIDX_2503 ON merchbaseproperty (p_merchindexingconfig);

CREATE INDEX merchindexingconfigposPosIDX_2503 ON merchbaseproperty (p_merchindexingconfigpos);


CREATE CACHED TABLE merchidxtocatve2505sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2505Sn ON merchidxtocatve2505sn (ITEMPK);

CREATE INDEX IdxsourcePK_2505Sn ON merchidxtocatve2505sn (sourcePK);

CREATE INDEX IdxtargetPK_2505Sn ON merchidxtocatve2505sn (targetPK);

CREATE INDEX IdxlanguagePK_2505Sn ON merchidxtocatve2505sn (languagePK);


CREATE CACHED TABLE merchidxtocatvers
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_2505 ON merchidxtocatvers (RSequenceNumber);

CREATE INDEX linksource_2505 ON merchidxtocatvers (SourcePK);

CREATE INDEX seqnr_2505 ON merchidxtocatvers (SequenceNumber);

CREATE INDEX qualifier_2505 ON merchidxtocatvers (Qualifier);

CREATE INDEX linktarget_2505 ON merchidxtocatvers (TargetPK);


CREATE CACHED TABLE merchindexingco2500sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2500Sn ON merchindexingco2500sn (ITEMPK);


CREATE CACHED TABLE merchindexingconfig
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_language BIGINT,
    p_currency BIGINT,
    p_baseimageurl NVARCHAR(255),
    p_baseproductpageurl NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE merchproductdir2506sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2506Sn ON merchproductdir2506sn (ITEMPK);


CREATE CACHED TABLE merchproductdir2509sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2509Sn ON merchproductdir2509sn (ITEMPK);

CREATE INDEX IdxsourcePK_2509Sn ON merchproductdir2509sn (sourcePK);

CREATE INDEX IdxtargetPK_2509Sn ON merchproductdir2509sn (targetPK);

CREATE INDEX IdxlanguagePK_2509Sn ON merchproductdir2509sn (languagePK);


CREATE CACHED TABLE merchproductdirconfig
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_currency BIGINT,
    p_baseimageurl NVARCHAR(255),
    p_basecatalogpageurl NVARCHAR(255),
    p_rollupstrategy NVARCHAR(255),
    p_rollupstrategyfield NVARCHAR(255),
    p_cdsidentifier NVARCHAR(255),
    p_displayname NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE CACHED TABLE merchproductdirtocatver
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_2509 ON merchproductdirtocatver (RSequenceNumber);

CREATE INDEX linksource_2509 ON merchproductdirtocatver (SourcePK);

CREATE INDEX seqnr_2509 ON merchproductdirtocatver (SequenceNumber);

CREATE INDEX qualifier_2509 ON merchproductdirtocatver (Qualifier);

CREATE INDEX linktarget_2509 ON merchproductdirtocatver (TargetPK);


CREATE CACHED TABLE merchsynchconfi2504sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_2504Sn ON merchsynchconfi2504sn (ITEMPK);


CREATE CACHED TABLE merchsynchconfig
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_catalogversion BIGINT,
    p_enabled TINYINT,
    p_basecategoryurl NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE ondemandglobalp6299sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6299Sn ON ondemandglobalp6299sn (ITEMPK);


CREATE CACHED TABLE ondemandglobalpreference
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_atspollingtime BIGINT,
    p_tenantid NVARCHAR(255),
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE ondemstorepref
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    PK BIGINT NOT NULL,
    sealed TINYINT,
    p_externalcallsenabled TINYINT,
    p_atsformula NVARCHAR(255),
    p_basestore BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE INDEX basestoreRelIDX_6222 ON ondemstorepref (p_basestore);


CREATE CACHED TABLE ondemstorepref6222sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6222Sn ON ondemstorepref6222sn (ITEMPK);
...
CREATE CACHED TABLE packaginginfo3005sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_3005Sn ON packaginginfo3005sn (ITEMPK);
...
(
    ...
    p_authbypaytsrvcprvdr NVARCHAR(255),
    p_authbyacquirer NVARCHAR(255),
    p_authbydigitalpaytsrvc NVARCHAR(255),
    p_authstatus NVARCHAR(255),
    p_authstatusname NVARCHAR(255),
    p_consignment BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE INDEX consignmentRelIDX_2101 ON paymnttrnsctentries (p_consignment);
...
(
    ...
    p_productinterest BIGINT,
    p_product BIGINT,
    p_basesite BIGINT,
    p_key NVARCHAR(255),
    p_sessionid NVARCHAR(255),
    p_sessioncart BIGINT,
    p_sessionuser BIGINT,
    p_basestore BIGINT,
    p_polltransstatus NVARCHAR(255),
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE prod2bundletemp6303sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6303Sn ON prod2bundletemp6303sn (ITEMPK);

CREATE INDEX IdxsourcePK_6303Sn ON prod2bundletemp6303sn (sourcePK);

CREATE INDEX IdxtargetPK_6303Sn ON prod2bundletemp6303sn (targetPK);

CREATE INDEX IdxlanguagePK_6303Sn ON prod2bundletemp6303sn (languagePK);


CREATE CACHED TABLE prod2bundletemplrel
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_6303 ON prod2bundletemplrel (RSequenceNumber);

CREATE INDEX linksource_6303 ON prod2bundletemplrel (SourcePK);

CREATE INDEX seqnr_6303 ON prod2bundletemplrel (SequenceNumber);

CREATE INDEX qualifier_6303 ON prod2bundletemplrel (Qualifier);

CREATE INDEX linktarget_6303 ON prod2bundletemplrel (TargetPK);
...
CREATE CACHED TABLE productinterest9865sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9865Sn ON productinterest9865sn (ITEMPK);


CREATE CACHED TABLE productinterests
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    p_basestore BIGINT,
    p_notificationtype BIGINT,
    p_emailenabled TINYINT,
    p_smsenabled TINYINT,
    p_notificationchannels LONGVARCHAR,
    p_basesite BIGINT,
    p_language BIGINT,
    p_customer BIGINT,
    p_product BIGINT,
...
CREATE INDEX IdxProductInterestForNotification_9865 ON productinterests (p_notificationtype, p_customer, p_basestore, p_basesite, p_product);

CREATE INDEX customerRelIDX_9865 ON productinterests (p_customer);

CREATE INDEX productRelIDX_9865 ON productinterests (p_product);
...
(
    ...
    p_reviewcount INTEGER,
    p_reviewrating DOUBLE,
    p_soldindividually TINYINT,
    p_sequenceid BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
...
CREATE CACHED TABLE req2dependbundl6312sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6312Sn ON req2dependbundl6312sn (ITEMPK);

CREATE INDEX IdxsourcePK_6312Sn ON req2dependbundl6312sn (sourcePK);

CREATE INDEX IdxtargetPK_6312Sn ON req2dependbundl6312sn (targetPK);

CREATE INDEX IdxlanguagePK_6312Sn ON req2dependbundl6312sn (languagePK);


CREATE CACHED TABLE req2dependbundletemplrel
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX rseqnr_6312 ON req2dependbundletemplrel (RSequenceNumber);

CREATE INDEX linksource_6312 ON req2dependbundletemplrel (SourcePK);

CREATE INDEX seqnr_6312 ON req2dependbundletemplrel (SequenceNumber);

CREATE INDEX qualifier_6312 ON req2dependbundletemplrel (Qualifier);

CREATE INDEX linktarget_6312 ON req2dependbundletemplrel (TargetPK);
...
CREATE CACHED TABLE restockconfig6508sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6508Sn ON restockconfig6508sn (ITEMPK);
...
CREATE CACHED TABLE sapdigipayclien9338sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9338Sn ON sapdigipayclien9338sn (ITEMPK);


CREATE CACHED TABLE sapdigipayclient
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE CACHED TABLE sapdigipayconfi9337sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9337Sn ON sapdigipayconfi9337sn (ITEMPK);


CREATE CACHED TABLE sapdigipayconfig
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
    ...
    sealed TINYINT,
    p_name NVARCHAR(255),
    p_sapdigitalpaymentclient BIGINT,
    p_baseurl NVARCHAR(255),
    p_paymentauthtype BIGINT,
    p_companycode NVARCHAR(255),
    p_customercountry NVARCHAR(255),
    p_paymentmethod NVARCHAR(255),
    p_customparam NVARCHAR(255),
    p_maxretry INTEGER,
    p_retryinterval INTEGER,
    p_timeout INTEGER,
    p_pollcarddelay INTEGER,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);
...
(
    ...
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    p_group NVARCHAR(255),
    p_requiredfields LONGVARBINARY,
    PRIMARY KEY (PK)
);
...
CREATE CACHED TABLE sitemessages
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX IDX_SITE_MESSAGE_UID_9875 ON sitemessages (p_uid);


CREATE CACHED TABLE sitemessages9875sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9875Sn ON sitemessages9875sn (ITEMPK);


CREATE CACHED TABLE sitemessageslp
(
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
    LANGPK BIGINT,
...
CREATE CACHED TABLE sitemsgforcusto9876sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_9876Sn ON sitemsgforcusto9876sn (ITEMPK);


CREATE CACHED TABLE sitemsgforcustomers
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX IDX_MESSAGE_9876 ON sitemsgforcustomers (p_message);

CREATE INDEX IDX_CUSTOMER_9876 ON sitemsgforcustomers (p_customer);
...
CREATE CACHED TABLE sourcingban6507sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6507Sn ON sourcingban6507sn (ITEMPK);
...
CREATE CACHED TABLE sourcingconfigs6510sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6510Sn ON sourcingconfigs6510sn (ITEMPK);
...
(
    ...
    sealed TINYINT,
    p_streamid NVARCHAR(255),
    p_itemtypeforstream BIGINT,
    p_whereclause LONGVARCHAR,
    p_versionselectclause LONGVARCHAR,
    p_active TINYINT,
    p_infoexpression LONGVARCHAR,
    p_container BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
...
CREATE CACHED TABLE streamcfg8102sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8102Sn ON streamcfg8102sn (ITEMPK);


CREATE CACHED TABLE streamcfgcontai8101sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_8101Sn ON streamcfgcontai8101sn (ITEMPK);


CREATE CACHED TABLE streamcfgcontainer
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
(
    ...
    p_otheritem BIGINT,
    p_detail BIGINT,
    p_bigdecimal DECIMAL(30,8),
    p_datecollection LONGVARBINARY,
    p_biginteger LONGVARBINARY,
    p_enumlist LONGVARCHAR,
    p_item BIGINT,
    p_master BIGINT,
    PRIMARY KEY (PK)
);
...
(
    ...
    p_type BIGINT,
    p_emailpreference TINYINT,
    p_smspreference TINYINT,
    p_notificationchannels LONGVARCHAR,
    p_active TINYINT,
    p_email NVARCHAR(255),
...
CREATE CACHED TABLE warehousebin6512sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6512Sn ON warehousebin6512sn (ITEMPK);


CREATE CACHED TABLE warehousebinent6513sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6513Sn ON warehousebinent6513sn (ITEMPK);
...
CREATE CACHED TABLE warehousedelive3008sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_3008Sn ON warehousedelive3008sn (ITEMPK);

CREATE INDEX IdxsourcePK_3008Sn ON warehousedelive3008sn (sourcePK);

CREATE INDEX IdxtargetPK_3008Sn ON warehousedelive3008sn (targetPK);

CREATE INDEX IdxlanguagePK_3008Sn ON warehousedelive3008sn (languagePK);
...
CREATE CACHED TABLE warehousetransf6514sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6514Sn ON warehousetransf6514sn (ITEMPK);


CREATE CACHED TABLE warehousetransf6515sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6515Sn ON warehousetransf6515sn (ITEMPK);
...
CREATE CACHED TABLE workflowtemp4ca1109sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_1109Sn ON workflowtemp4ca1109sn (ITEMPK);

CREATE INDEX IdxsourcePK_1109Sn ON workflowtemp4ca1109sn (sourcePK);

CREATE INDEX IdxtargetPK_1109Sn ON workflowtemp4ca1109sn (targetPK);

CREATE INDEX IdxlanguagePK_1109Sn ON workflowtemp4ca1109sn (languagePK);


CREATE CACHED TABLE workflowtemp4catvers
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
(
    ...
    p_applicationid NVARCHAR(255),
    p_formid NVARCHAR(255),
    p_refid NVARCHAR(255),
    p_system TINYINT,
    p_type BIGINT,
    p_content LONGVARCHAR,
    p_formdefinition BIGINT,
    aCLTS BIGINT DEFAULT 0,
    propTS BIGINT DEFAULT 0,
    PRIMARY KEY (PK)
);

CREATE INDEX applicationId_6341 ON yformdata (p_applicationid);

CREATE INDEX refId_6341 ON yformdata (p_refid);

CREATE INDEX id_6341 ON yformdata (p_id);

CREATE INDEX formdefinitionRelIDX_6341 ON yformdata (p_formdefinition);


CREATE CACHED TABLE yformdata6341sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6341Sn ON yformdata6341sn (ITEMPK);


CREATE CACHED TABLE yformdatahistor6342sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6342Sn ON yformdatahistor6342sn (ITEMPK);


CREATE CACHED TABLE yformdatahistory
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX formdataRelIDX_6342 ON yformdatahistory (p_formdata);

CREATE INDEX formdataposPosIDX_6342 ON yformdatahistory (p_formdatapos);


CREATE CACHED TABLE yformdefinition
(
    hjmpTS BIGINT,
    createdTS TIMESTAMP,
    modifiedTS TIMESTAMP,
...
CREATE INDEX applicationId_6340 ON yformdefinition (p_applicationid);

CREATE INDEX formId_6340 ON yformdefinition (p_formid);

CREATE INDEX version_6340 ON yformdefinition (p_version);


CREATE CACHED TABLE yformdefinition6340sn
(
    ID BIGINT IDENTITY,
    ITEMPK BIGINT,
    ITEMTYPEPK BIGINT,
...
CREATE INDEX IdxITEMPK_6340Sn ON yformdefinition6340sn (ITEMPK);
